...
@interface AceTM (SWIFT_EXTENSION(AceTM))
+ (BOOL)uiWebViewWithWebView:(UIWebView * _Nullable)webView shouldStartLoadWith:(NSURLRequest * _Nullable)request navigationType:(UIWebViewNavigationType)navigationType SWIFT_AVAILABILITY(ios,introduced=1.2.0,message="UIWebview 사용시 Ace 웹스크립트와 통신할때 사용");
