...
@interface AceTM (SWIFT_EXTENSION(AceTM))
+ (void)appDidFinishLaunchingWithResponder:(UIResponder * _Nullable)responder SWIFT_AVAILABILITY(ios,unavailable,message="'appDidFinishLaunching' has been renamed to 'appDidFinishLaunchingWithConfiguration:': appDidFinishLaunching 안에서 호출");
