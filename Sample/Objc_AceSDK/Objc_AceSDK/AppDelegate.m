...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    AceConfiguration *aceConfiguration = [[[[[[Builder alloc] init] setServiceIdWithServiceId:@"YOUR_ACECOUNTER_SID"]
                                            setDebugModeWithDebug:YES]
                                           setCordovaPluginModeWithCordovaPluginMode:NO] build];
    [AceTM appDidFinishLaunchingWithConfiguration:aceConfiguration];
    return YES;
}
