...
+ (void)webViewDidStartLoadWithWebView:(UIWebView * _Nonnull)webView SWIFT_AVAILABILITY(ios,deprecated=1.0.8,message="uiWebViewDidStartLoad를 사용하세요");
...
+ (void)uiWebViewDidStartLoadWithWebView:(UIWebView * _Nonnull)webView SWIFT_AVAILABILITY(ios,introduced=1.0.8,message="UIWebview에서 load가 시작된 경우 사용");
+ (void)webViewDidFinishLoadWithWebView:(UIWebView * _Nonnull)webView SWIFT_AVAILABILITY(ios,deprecated=1.0.8,message="uiWebViewDidFinishLoad를 사용하세요");
+ (void)uiWebViewDidFinishLoadWithWebView:(UIWebView * _Nonnull)webView SWIFT_AVAILABILITY(ios,introduced=1.0.8,message="UIWebview에서 load가 끝난 경우 사용");
...
+ (void)wkWebViewDidFinishLoadWithWebView:(WKWebView * _Nonnull)webView;
+ (void)wkWebViewDidStartLoadWithWebView:(WKWebView * _Nonnull)webView;
@end
